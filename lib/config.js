...
const DEFAULT_CONFIG = {
    ...
    generateArgTypes: false,
    useStorybookActions: true, // Standardmäßig AN, da es oft nützlich ist
};
...
function getConfig() {
    ...
    const argv = yargs(hideBin(process.argv))
        ...
        .option('generateArgTypes', { /* ... */ })
        .option('useStorybookActions', {
            alias: 'ua', // oder 'sa'
            type: 'boolean',
            default: yargsDefaults.useStorybookActions,
            description: "Generiert 'action(\"propName\")' für Funktions-Props im args Objekt.",
        })
    ...
    const config = {
        ...
        useStorybookActions: argv.useStorybookActions,
    };
